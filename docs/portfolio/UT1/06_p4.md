...
# Enfoque metodológico: Modelización de Precios de Viviendas mediante Regresión Lineal
...
## 🏠 **Carga de Dataset de Boston Housing**
...
## **Implementación y Entrenamiento del Modelo de Regresión Lineal**
...
# Aplicación de la Regresión Logística en Contextos de Diagnóstico Médico
## **Procesamiento Inicial de la Base de Datos Clínica**
...
# **Actividad Final - Compara los Dos Modelos**
